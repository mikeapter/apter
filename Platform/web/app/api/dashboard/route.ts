...
import { nowIso, resolveTierFromRequest } from "../_shared/devData";
...
export async function GET(req: Request) {
  ...
  return NextResponse.json({
    ...
    system_history: {
      regime_transitions: [
        {
          ts: "2026-02-01 15:10:00",
          from: "NEUTRAL",
          to: "RISK-OFF",
          note: "Volatility expanded; correlation increased.",
        },
        {
          ts: "2026-02-02 10:05:00",
          from: "RISK-OFF",
          to: "NEUTRAL",
          note: "Correlation normalized; volatility stabilized.",
        },
      ],
      no_trade_periods: [
        {
          ...
          reason: "Event risk elevated; spreads widened beyond tolerance.",
        },
        {
